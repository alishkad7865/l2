...
public class Ingredient {
    ...
    ingredient.put("Pickle",0.03);
    ingredient.put("Spinach",0.20);
    ingredient.put("Red Onion",0.01);
    ingredient.put("Ritz Crackers",0.25);
    ingredient.put("Tomato",0.07);
    ingredient.put("Fries",0.30);
    ingredient.put("Gravy",0.10);
    }
}
